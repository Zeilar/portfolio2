        ...
        <Container maxW="container.xl">
          ...
          <Flex gap={[4, 8]} flexDir={["column", "row"]}>
            ...
            <Text color="gray.200" maxW={["auto", "50%"]}>
              My journey as a developer started in high school where I studied
              game development, where we coded primarily in C# and the
              framework&nbsp;
              <Link
              ...
              . I migrated towards web development instead and after two 2-year
              educations which included a lot of internship, I was more than
              ready to become a professional.
              <br />
              <br />
              Most of my spare time goes towards the computer. Be it
              programming, gaming or watching videos. You may call me a{" "}
              <i>supernerd</i>. Shoutout to&nbsp;
              <Link href="https://www.coffeestainstudios.com/" isExternal>
                Coffe Stain Studios
              </Link>
              .
            </Text>
